...
std::vector<float> GemmCUBLAS(const std::vector<float>& a, const std::vector<float>& b, int n) {
  ...
  cublasGemmEx(handle, CUBLAS_OP_N, CUBLAS_OP_N, n, n, n, &alpha, device_b, CUDA_R_32F, n, device_a, CUDA_R_32F, n, &beta, device_c, CUDA_R_32F, n, CUBLAS_COMPUTE_32F_FAST_16F, CUBLAS_GEMM_DEFAULT);
